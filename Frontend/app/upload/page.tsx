    ...
    const handleSubmit = async (event: React.FormEvent<HTMLFormElement>) => {
        ...
        try {
            ...
            toast({
                ...
                description: "Redirecting to ML Simulation Sandbox...",
            });

            // ✅ Redirect to /Simulation2 after a short delay
            setTimeout(() => {
            ...
            <div className="container mx-auto px-4 py-6">
                <div className="mb-6">
                    ...
                    <p className="text-muted-foreground">
                        Upload your ARGO or Map Data to get personalized
                ...
                <div className="grid lg:grid-cols-2 gap-6">
                    ...
                    <Card>
                        <CardHeader>
                            ...
                            <CardDescription>
                                Supported formats: .nc, GeoTIFF, GeoJSON (Max:
                                50MB)
                            </CardDescription>
                        </CardHeader>
                        <CardContent>
                            <form onSubmit={handleSubmit} className="space-y-6">
                                ...
                                <div className="space-y-2">
                                    ...
                                    >
                                        ...
                                        <SelectContent>
                                            <SelectItem value="unet">
                                                U-Net (Segmentation)
                                            </SelectItem>
                                            <SelectItem value="lstm">
                                                LSTM (Time Series)
                                            </SelectItem>
                                            <SelectItem value="unet-lstm">
                                                U-Net + LSTM (Hybrid)
                                            </SelectItem>
                            ...
                            <Card>
                                ...
                                <CardContent className="space-y-4">
                                    <Alert>
                                        ...
                                        <AlertDescription>
                                            Upload your dataset and fill in
                                            details to start analysis.
                                        </AlertDescription>
                                    </Alert>

                                    <ul className="text-sm space-y-1 text-muted-foreground">
                                        <li>
                                            • Supported: .nc, .tiff, .geojson
                                        </li>
                                        <li>• Max size: 50MB</li>
                                        <li>
                                            • Choose model & optional metadata
                                        </li>
                                    </ul>
                                </CardContent>
                            </Card>
